...
module.exports = {
    ...
    premium: false,
    alias: ['rm'],
    description: "¿Te amenazan con raidear tu servidor? Con este sistema nadie podrá tocarte.",
